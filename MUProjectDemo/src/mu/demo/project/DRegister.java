...
public class DRegister extends JFrame implements ActionListener,ListSelectionListener {
	...
	public DRegister()
	{
		...
		f=new Font("Consolas", Font.BOLD, 13);
		...
		btnlogin.setBounds(280, 220, 70, 40);
		btnlogin.setFont(f);
		frm.add(btnlogin);
