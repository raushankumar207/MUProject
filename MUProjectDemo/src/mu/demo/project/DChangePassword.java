...
import cpassword.ChangePassword;
...
public class DChangePassword implements FocusListener,ActionListener {
	...
	public DChangePassword()
	{
		...
		lblsecquestion.setBounds(20, 60, 120, 30);
		...
		lblsecans.setBounds(20, 100, 110, 30);
		lblsecans.setFont(f);
		frm.add(lblsecans);
		...
		lblcpassword.setBounds(20, 180, 120, 30);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(frmvalidate())
		{
			if(strongpassword(txtpassword.getText()))
			{
				...
				if(ch.valsecquesans())
				{
					//JOptionPane.showMessageDialog(null, "Security Answer Match Successfully");
